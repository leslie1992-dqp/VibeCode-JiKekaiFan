<template>
  <section class="card auth-card">
    ...
    <p class="auth-lead">创建账号，加入即刻开饭</p>
    <form class="auth-form" :aria-busy="submitting" @submit.prevent="handleRegister">
      <div class="form-row auth-field">
        <label class="auth-label" for="register-mobile">手机号</label>
        <input
          id="register-mobile"
          v-model="mobile"
          class="auth-input"
      ...
      <div class="form-row auth-field">
        <label class="auth-label" for="register-nickname">昵称</label>
        <input
...
async function handleRegister() {
  ...
  try {
    ...
    showToast("error", getApiErrorMessage(err, "注册失败"));
  } finally {
